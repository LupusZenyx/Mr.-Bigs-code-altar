class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Address erzeugt.");
        ...
        lieferserviceVerwaltung.berechneWartezeit(b1, k1);
        lieferserviceVerwaltung.berechneWartezeit(b2, k2);
        System.out.println("BerechneWartezeit Methode für alle Bestellungen.");
