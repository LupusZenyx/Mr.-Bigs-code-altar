...
/* helper functions */
function setSingleDataText(no, htmlName, dataName) {
    cardsList[no].getElementsByClassName(htmlName)[0].innerHTML = cardData[no][dataName];
}

function setSingleDataSrc(no, htmlName, dataName) {
    cardsList[no].getElementsByClassName(htmlName)[0].setAttribute("src", cardData[no][dataName]);
}
function setSingleDataLink(no, htmlName, dataName) {
    cardsList[no].getElementsByClassName(htmlName)[0].setAttribute("href", cardData[no][dataName]);
}

/* Main unction of function */
function setDataCardNoX(no) {
